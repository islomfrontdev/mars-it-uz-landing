...
function t396_doResize(t) {
  ...
  "window" === t396_ab__getFieldValue(a, "upscale") &&
    ...
    "function" != typeof window.t396__updateTopShift ||
      ("y" !== t396_ab__getFieldValue(a, "shift-processed") &&
        "y" !== t396_ab__getFieldValue(a, "fixed-shift")) ||
      t396__updateTopShift(t, !0),
...
function t396_artboard_build(t, e) {
  ...
  var a = document.createEvent("Event"),
    r =
      (a.initEvent("artBoardRendered", !0, !0), o.querySelectorAll(".tn-elem")),
    r =
  ...
  ("visible" !== r && "visibleX" !== r) || !n || (n.style.overflow = "hidden"),
    "auto" === r &&
      0 !== (a = Math.abs(o.offsetHeight - o.clientHeight)) &&
      (o.style.paddingBottom = a + "px"),
    (window.t396__isMobile ||
      ("ontouchend" in document &&
        -1 !== navigator.userAgent.indexOf("AppleWebKit"))) &&
...
function t396_ab__renderView(t) {
  ...
  if (
    (l && !i && _ && (o = parseInt(r, 10) * window.tn_scale_factor),
    r === d || (o && d <= o))
  )
    a = 0;
  else
  ...
  (l = t.querySelector(".t396__filter")),
      ...
      switch (e) {
        ...
        case "width":
          switch (
            ...
            (c = t.getAttribute("data-elem-type")))
          ) {
            case "tooltip":
  ...
  if ((t = t396_getEl(t))) {
    ...
    switch (((i = parseInt(i)), e)) {
      ...
      case "top":
        ...
        var b,
          f = t.parentNode,
          m = (f = f.classList.contains("t396__artboard") ? f : f.parentNode)
