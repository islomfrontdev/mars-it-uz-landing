...
function t_zeroForms__renderForm(zeroForm, formObjectEls, recid, tildamode) {
  if (
    ...
    recid || (recid = t_zeroForms__getRecID(zeroForm)),
  ...
  var record = document.querySelector(".t-records"),
    ...
    rec;
  if (
    (isEditMode || (isEditMode = "published" !== tildamode),
    ...
    if ("zero" === tildamode || "edit" === tildamode)
    ...
    if (form) {
      ...
      customElEvent.initEvent("render", !0, !0),
        ...
        t_zeroForms__updateTopPosition(zeroForm);
    }
  }
}
...
function t_zeroForms__createForm(recid, tildamode, arrayOfElements, zeroForm) {
  ...
  if (
    ...
    isPublished &&
      ...
      (form.action =
        "https://forms.amocrm.ru/forms/assets/js/amoforms.js?1679933387"),
      (form.method = "POST"),
  ...
  form.insertAdjacentElement(
    ...
    ("h" !== formObj.inputpos && "zero" !== tildamode) ||
  ...
  if (formObj.fieldfontfamily) {
    ...
    t_zeroForms__setScriptOrStyle(
      ...
      (selectorList = selectorList.reduce(function (prev, next, i) {
        return (
          (prev += fontFamilySelector + ".t-input-block " + next),
          i !== selectorList.length - 1 && (prev += ", "),
          prev
        );
      }, "")) +
        ' {font-family: "' +
    ...
    fieldFontFamilyStyles &&
      fieldFontFamilyStyles.parentElement &&
      fieldFontFamilyStyles.parentElement.removeChild(fieldFontFamilyStyles);
  }
  if (
    ...
    window.addEventListener(event, function () {
      timerID ||
        (timerID = setTimeout(function () {
          t_zeroForms__updateCurrentResolution(recid, tildaMode),
...
function t_zeroForms__updateTopPosition(zeroForm) {
  ...
  void 0 !== window.t396_elem__getFieldValue &&
    ...
    "top" !== t396_elem__getFieldValue(zeroForm, "axisy") &&
...
function t_zeroForms__createSelect(
  elementObj,
  inputStyles,
  inputPreferences,
  hasBBOnly
...
function t_zeroForms__createDateField(
  ...
  datepickerRestrictions.length &&
    "," === datepickerRestrictions[datepickerRestrictions.length - 1] &&
    (datepickerRestrictions = datepickerRestrictions.slice(0, -1)),
...
function t_zeroForms__generateBtnStyles(btn, recid, formID, formObj, zeroForm) {
  ...
  var transition,
    styleValue =
      ...
      "{" +
      buttonStyles +
      (buttonHoverStyles ? "transition: 0.3s ease all;" : "") +
      "}",
  ...
  if (
    ...
    btnHoverStyles &&
      btnHoverStyles.parentElement &&
      btnHoverStyles.parentElement.removeChild(btnHoverStyles),
      t_zeroForms__setScriptOrStyle(
        btnHoverStylesID,
        "",
        styleHoverValue,
...
function t_zeroForms__generateButtonStyles(formObj, btnFontFamily) {
  ...
  return (stylesString += t_zeroForms__processButtonBG(
    formObj.buttonbgcolor,
    !1
  ));
}
function t_zeroForms__processButtonBG(buttonBG, isHover) {
  ...
  if (-1 !== buttonBG.indexOf("-gradient("))
    return "background-image: " + buttonBG + ";";
...
function t_zeroForms__generateButtonHoverStyles(formObj) {
  if (
    !(
      formObj.buttonhovercolor ||
      formObj.buttonhoverbordercolor ||
      formObj.buttonhoverbgcolor ||
      formObj.buttonhovershadowsize
    )
  )
    return "";
  var buttonHoverStyles = {
    color: formObj.buttonhovercolor || "",
    "border-color": formObj.buttonhoverbordercolor || "",
  };
  (formObj.buttonhovershadowsize || formObj.buttonshadowopacity) &&
    (buttonHoverStyles["box-shadow"] =
      "0px 0px " +
      (formObj.buttonhovershadowsize
        ? formObj.buttonhovershadowsize + "px"
        : "10px") +
      " 0px rgba(0, 0, 0, " +
      (formObj.buttonshadowopacity
        ? formObj.buttonshadowopacity / 100
      ...
      ")");
  var stylesString = "";
  for (var k in buttonHoverStyles)
    buttonHoverStyles[k] &&
      (stylesString += k + ":" + buttonHoverStyles[k] + ";");
  return (stylesString += t_zeroForms__processButtonBG(
    formObj.buttonhoverbgcolor,
    !0
  ));
...
function t_zeroForms__initInputStyles(formObj, inputFontWeight) {
  var inputStyles = {
      ...
      border: formObj.inputbordersize
        ? formObj.inputbordersize +
          "px solid " +
          (formObj.inputbordercolor || "#000")
        : "",
...
function t_zeroForms__isFormOutside(form) {
  ...
  formTopPos &&
    formTopPos.indexOf("px") &&
    (formTopPos = parseInt(formTopPos, 10)),
    (formTopPos = "number" == typeof formTopPos ? formTopPos : 0) < 0 &&
      formTopPos > -50 &&
      (formTopPos = 0),
    isScaled &&
      !isOnlyScalable &&
      ((formLeftPos *= window.tn_scale_factor),
  ...
  var hasFixedAnimation = form.hasAttribute("data-animate-fix"),
    ...
    isVerticalBotttomOutside =
      artBoardPos.height > 0 && formTopPos > artBoardPos.height && !hasParallax;
  return (
    isVerticalTopOutside ||
    isVerticalBotttomOutside ||
    formLeftPos > artBoardRightPos
  );
}
function t_zeroForms__getFieldValue(element, attrName, prop) {
  if (element && void 0 !== window.tn) {
    var artBoard,
      abResObj = t_zeroForms__getResOpts(
        element.closest(".t396__artboard, .tn-artboard")
      ),
      postfix = "data-field" === attrName ? "-value" : "",
      desktopAttr = t_zeroForms__generateAttribute(attrName, prop, postfix, !1);
    if (abResObj.res === abResObj.resMax)
      return element.getAttribute(desktopAttr);
    var responsiveAttr = t_zeroForms__generateAttribute(
        attrName,
        prop,
        postfix,
        abResObj.res
    ...
    return "string" == typeof currentValue
      ...
      : (abResObj.breakpoints.forEach(function (breakpoint) {
          if (
            !(breakpoint <= abResObj.res || "string" == typeof currentValue)
          ) {
            var curBreakpointAttr = t_zeroForms__generateAttribute(
              attrName,
              prop,
              postfix,
              breakpoint
        ...
        "string" == typeof currentValue
          ? currentValue
          : element.getAttribute(desktopAttr) || "");
  }
}
  ...
  return recid && window.tn["ab" + recid]
    ? {
        res: window.t396_detectResolution
          ? t396_detectResolution(recid)
          : window.tn["ab" + recid].curResolution,
        resMax: window.tn["ab" + recid].curResolution_max,
        breakpoints: window.tn["ab" + recid].screens.slice(0, -1),
      }
    : window.tn.screens
    ? {
...
function t_zeroForms__getRecID(elem) {
  ...
  return artBoard
    ? artBoard.getAttribute("data-artboard-recid") ||
        artBoard.getAttribute("data-record-id")
    : "";
}
