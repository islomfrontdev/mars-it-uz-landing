function t396_scaleBlock(e) {
  ...
  y &&
    ((u =
      (u =
        window.tn && window.tn["ab" + e] && window.tn["ab" + e].scaleFactor) ||
    ...
    t &&
      ((o = t396_ab__getFieldValue(y, "height")),
      (l = (t = t396_ab__getHeight(y)) <= (o = o * u) ? o : t)),
        ...
        if (h) {
          ...
          var l = getComputedStyle(e).backdropFilter,
            l =
              (l &&
                ...
                (d.style.backdropFilter = l),
                "0px" !== (l = getComputedStyle(t).borderRadius) &&
                  (d.style.borderRadius = l)),
              e.querySelector(".t-bgimg"));
          l &&
          ...
          if ("video" !== o && _ && !a && !i && !r) {
            ...
            var s,
              ...
              p =
                ((m =
                  (m = t396_elem__convertPosition__Local__toAbsolute(
                    e,
                    "top",
                    m
                  )) *
            ...
            for (
              p =
                ...
                e.style.left = p + "px",
                (s = t.parentNode) &&
                  s.classList.contains("tn-atom__scale-wrapper") &&
                  (s = s.parentNode),
                (d = document.createElement("div")).classList.add(
                  "tn-atom__scale-wrapper"
                ),
