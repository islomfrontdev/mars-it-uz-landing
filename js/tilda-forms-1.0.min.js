(window.t_forms__lang = (
  ...
  window.tildaApiServiceRootDomain &&
    0 < window.tildaApiServiceRootDomain.indexOf(".") &&
    (window.tildaForm.endpoint = "forms." + window.tildaApiServiceRootDomain),
  t_onReady(function () {
  ...
  (window.tildaForm.send = function (form, btnSubmit, formType, formKey) {
    ...
    if (
      ...
      var formUrl = `https://test.api.marsit.uz/api/v1/leads/landing-form`,
        dataForm = [],
        arrFilter = [];
      if (
      ...
      phone = dataForm.find((el) => el.name === "Phone").value;
      formUrl = `https://api.marsit.uz/api/v1/leads/landing-form?phone=${phone}`;
        ...
        (xhr.onreadystatechange = function () {
          if (4 === xhr.readyState) {
            if (200 <= xhr.status && xhr.status < 400) {
              window.location = "/success-uz.html";
